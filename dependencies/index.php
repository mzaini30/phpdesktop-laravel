...
<p>
    ...
    <select onchange="document.getElementById('myform').action=this.value;">
        ...
        <option value="/index.php/company/5">
            /index.php/company/5
        </option>
        <option value="/index.php/company/5.html">
            /index.php/company/5.html
        </option>
    </select>
...
<p>
    ...
    <ul>
    <li><a href="/index.php/company/5">
        /index.php/company/5</a>
    <li><a href="/index.php/company/5?xyz=1">
        /index.php/company/5?xyz=1</a>
    <li><a href="/index.php/company\5">
        /index.php/company\5</a>
    <li><a href="/index.php?xyz=1">
        /index.php?xyz=1</a>
    </ul>
</p>
